require 'spec_helper'
require 'omniauth-calendar'

describe OmniAuth::Strategies::Calendar do
  ...
  subject do
    ...
    OmniAuth::Strategies::Calendar.new(app, *args).tap do |strategy|
  ...
  describe '#callback_path' do
    it 'has the correct callback path' do
      subject.callback_path.should eq('/auth/calendar/callback')
    end
  end
